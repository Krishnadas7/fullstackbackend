...
class ConversationRepository {
    constructor(conversationModels) {
        this.conversationModels = conversationModels;
    }
    addConversation(senderId, receiverId) {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, addConversation_1.addConversation)(senderId, receiverId, this.conversationModels);
        });
    }
    getConversation(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, getConversation_1.getConversation)(userId, this.conversationModels);
        });
    }
}
