...
const getcompanyData = (companyRepository, token) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const decoded = yield jsonwebtoken_1.default.verify(token, process.env.ACCESS_TOKEN_KEY);
        const companyData = yield companyRepository.findCompanyWithId(decoded.id);
        return {
